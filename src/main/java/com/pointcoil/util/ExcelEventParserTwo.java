...
import com.pointcoil.dto.map.AreYouHungryDTO;
...
@Component
public class ExcelEventParserTwo {
    ...
    public static List<AreYouHungryDTO> getThermodynamicDTOS() {
        return thermodynamicDTOS;
    }

    public static List<AreYouHungryDTO> thermodynamicDTOS = new ArrayList<AreYouHungryDTO>();
    ...
    private static class SheetHandler extends DefaultHandler   {
        ...
        public void optRow(int sheetIndex, int curRow, List<String> rowlist) {
                    if(rowlist.size() == 9){
                        AreYouHungryDTO areYouHungryDTO = new AreYouHungryDTO(rowlist.get(0),rowlist.get(1),rowlist.get(2),rowlist.get(4),rowlist.get(8),rowlist.get(7),rowlist.get(3));
                        thermodynamicDTOS.add(areYouHungryDTO);
                    }
        }
