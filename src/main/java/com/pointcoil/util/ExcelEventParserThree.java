...
@Component
public class ExcelEventParserThree {
    ...
    private static class SheetHandler extends DefaultHandler   {
        ...
        public void optRow(int sheetIndex, int curRow, List<String> rowlist) {
            if(rowlist!=null&&rowlist.size()>0){
                ...
                gouldDTO.setId(rowlist.get(0));
                gouldDTO.setName(rowlist.get(1));
                gouldDTO.setCity(rowlist.get(2));
                gouldDTO.setClassification(rowlist.get(3));
                gouldDTO.setBaiduLat(rowlist.get(4));
                gouldDTO.setBaiduLon(rowlist.get(5));
